...
export const slide54Tokens = contentTokens["slide-54"];

export function buildSlide54(presentation, tokens = slide54Tokens) {
  const slide = presentation.slides.add();
  slide.background.fill = "#FFFFFF";
  slide.compose(
    layers({ name: "codex-grid-layout-library#slide-54", width: "fill", height: "fill" }, [
