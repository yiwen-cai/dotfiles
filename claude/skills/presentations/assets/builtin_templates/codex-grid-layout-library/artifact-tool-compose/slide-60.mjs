...
export const slide60Tokens = contentTokens["slide-60"];

export function buildSlide60(presentation, tokens = slide60Tokens) {
  const slide = presentation.slides.add();
  slide.background.fill = "#FFFFFF";
  slide.compose(
    layers({ name: "codex-grid-layout-library#slide-60", width: "fill", height: "fill" }, [
      text([tokens.body1.titleHere, tokens.body1.loremIpsumDolorSitAmetConsecteturAdipiscing], {
        name: "Content-Placeholder-15",
        ...frame({ left: "41px", top: "539px", width: "273px", height: "110px" }),
      ...
      text([tokens.body2.titleHere, tokens.body2.loremIpsumDolorSitAmetConsecteturAdipiscing], {
        ...
        ...frame({ left: "350px", top: "539px", width: "273px", height: "110px" }),
      ...
      shape({
        ...
        geometry: "roundRect",
        fill: "bg2",
        ...frame({ left: "41px", top: "109px", width: "271px", height: "416px" }),
      }),
      shape({
        name: "Rounded-Rectangle-4",
        geometry: "roundRect",
        fill: "bg2",
        ...frame({ left: "350px", top: "109px", width: "273px", height: "416px" }),
      }),
      shape({
        name: "Rounded-Rectangle-5",
        geometry: "roundRect",
        fill: "bg2",
        ...frame({ left: "657px", top: "109px", width: "271px", height: "416px" }),
      }),
      shape({
        name: "Rounded-Rectangle-6",
        geometry: "roundRect",
        fill: "bg2",
        ...frame({ left: "966px", top: "109px", width: "273px", height: "416px" }),
      }),
    ]),
