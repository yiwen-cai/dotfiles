...
export const slide65Tokens = contentTokens["slide-65"];

export function buildSlide65(presentation, tokens = slide65Tokens) {
  const slide = presentation.slides.add();
  slide.background.fill = "#FFFFFF";
  slide.compose(
    layers({ name: "codex-grid-layout-library#slide-65", width: "fill", height: "fill" }, [
      ...
      text([{ runs: ["Chart placeholder: bar"] }], {
        name: "Chart-6",
