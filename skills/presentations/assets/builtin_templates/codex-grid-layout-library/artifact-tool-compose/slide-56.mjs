...
export const slide56Tokens = contentTokens["slide-56"];

export function buildSlide56(presentation, tokens = slide56Tokens) {
  const slide = presentation.slides.add();
  slide.background.fill = "#FFFFFF";
  slide.compose(
    layers({ name: "codex-grid-layout-library#slide-56", width: "fill", height: "fill" }, [
      text([tokens.body1.titleHere, tokens.body1.loremIpsumDolorSitAmetConsecteturAdipiscing], {
        name: "Content-Placeholder-15",
        ...frame({ left: "41px", top: "507px", width: "273px", height: "123px" }),
      ...
      text([tokens.body2.titleHere, tokens.body2.loremIpsumDolorSitAmetConsecteturAdipiscing], {
        ...
        ...frame({ left: "350px", top: "507px", width: "273px", height: "123px" }),
