...
export const slide78Tokens = contentTokens["slide-78"];

export function buildSlide78(presentation, tokens = slide78Tokens) {
  const slide = presentation.slides.add();
  slide.background.fill = "#FFFFFF";
  slide.compose(
    layers({ name: "codex-grid-layout-library#slide-78", width: "fill", height: "fill" }, [
      shape({
        name: "Rounded-Rectangle-5",
        geometry: "roundRect",
        fill: "none",
        line: { style: "solid", width: 1.33, fill: "accent1" },
