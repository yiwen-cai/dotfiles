...
- **Validation command**: `python3 ~/.claude/skills/bupt-thesis-writer/scripts/check_bupt_thesis.py /public/home/caiyiwen/code/BUPTBachelorThesis`（该技能同时部署于各工具的 skills 目录）
